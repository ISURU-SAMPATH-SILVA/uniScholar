...
$result = $conn->query("SELECT id, file_name, file_path, uploaded_at FROM past_papers ORDER BY uploaded_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="background-color: var(--color-primary); min-height: 100vh; padding: 2rem 1.5rem;">
    ...
    <div class="Classroom-page-wrap">
        ...
        <div class="Classroom-hero">
            <div>
                <span class="Classroom-hero-tag"><i class="fa-solid fa-book"></i> Resources</span>
                <h1 class="Classroom-hero-title">Past Papers</h1>
                <p class="Classroom-hero-code">Everyone eken upload karapu past papers okkoma methana</p>
            </div>

            <a href="Past_Papers.php" class="Classroom-back-btn">
        ...
        <?php else: ?>
            <div class="Classroom-empty-state">
                ...
                <p>Mokkuth thawama upload karala na. Palamu wenna oyama upload karanna!</p>
            </div>
        <?php endif; ?>
