                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card explore-card bg-dark h-100 p-3 text-white border-secondary">
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-white-50 small flex-grow-1">Comprehensive reference documents encompassing layout trees, styles and frontend logic.</p>
                                <hr class="border-secondary my-3">
                                <div class="d-flex justify-content-between align-items-center mt-auto">
